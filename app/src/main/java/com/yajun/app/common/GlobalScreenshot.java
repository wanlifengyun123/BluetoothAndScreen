...
public class GlobalScreenshot {
     ...
     */
    public Bitmap takeScreenshot(View view, Runnable finisher, boolean statusBarVisible, boolean navBarVisible) {
        // Take the screenshot
